...
import List from './../Who/list/List';
...
window.scrollTo({ top: 0, behavior: 'smooth' })
  ...
  activeCategory === "all"
    ? reports.filter(
         report => report.title.toLocaleLowerCase().includes(search.toLowerCase())
      )
    : reports.filter(
    ...
    <>
     <div className="relative py-20 overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span
            className="px-4 py-2 text-sm font-medium text-orange-500 
             bg-orange-500/10 border border-orange-500/30 
             rounded-full inline-flex items-center gap-2 mb-6"
          >
            <span className="w-[6px] h-[6px] bg-orange-500 rounded-full animate-pulse mr-2"></span>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            استكشف{" "}
            <span
              className="bg-gradient-to-br from-orange-500 to-yellow-400
bg-clip-text text-transparent text-6xl font-bold"
            >
              مقالاتنا
            </span>
          </h1>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="relative w-full md:w-80">
              <input
                ...
                className=" w-full px-5 py-3 pr-12 bg-[#161616] rounded-xl text-neutral-400"
                type="text"
                value={search}
                onChange={(e)=>{
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <button className={activeCategory == "all"?"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-gradient-to-r from-orange-500 to-orange-600 text-white":"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30"} onClick={() => {
        setActiveCategory("all");
        setCurrentPage(1);
      }}>
                جميع المقالات
              </button>
              <button className={activeCategory == "إضاءة"?"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-gradient-to-r from-orange-500 to-orange-600 text-white":"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30"}onClick={() => {
        setActiveCategory("إضاءة");
        setCurrentPage(1);
      }}  >
                إضاءة
              </button>
              <button className={activeCategory == "بورتريه"?"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-gradient-to-r from-orange-500 to-orange-600 text-white":"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30"} onClick={() => {
        setActiveCategory("بورتريه");
        setCurrentPage(1);
      }} >
                بورتريه
              </button>
              <button className={activeCategory == "مناظر طبيعية"?"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-gradient-to-r from-orange-500 to-orange-600 text-white":"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30"} onClick={() => {
        setActiveCategory("مناظر طبيعية");
        setCurrentPage(1);
      }} >
                مناظر طبيعية
              </button>
              <button className={activeCategory == "تقنيات"?"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-gradient-to-r from-orange-500 to-orange-600 text-white":"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30"}onClick={() => {
        setActiveCategory("تقنيات");
        setCurrentPage(1);
      }} >
                تقنيات
              </button>
              <button className={activeCategory == "معدات"?"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-gradient-to-r from-orange-500 to-orange-600 text-white":"px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30"}
               onClick={() => {
        setActiveCategory("معدات");
        setCurrentPage(1);
      }}>
                معدات
              </button>
   ...
   <div className="bg-[#0a0a0a] ">
      ...
      <div className="max-w-7xl  mx-auto px-4 sm:px-6 lg:px-8 pt-12  "> <div className=" flex items-center justify-between">
            <p className="text-neutral-400">
              عرض <span className="font-bold text-white">{filteredReports.length}</span> مقالات
              <span>
                {activeCategory !== "all" && (
    <>
      {" في "}
      <span className="font-bold text-orange-500 capitalize">{activeCategory}</span>
    </>
  )}
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center bg-[#161616] border border-[#262626] rounded-xl p-1">
                <button
                  className={`p-2 rounded-lg transition-all duration-300 ${layout ==="list" ?`bg-orange-500 text-white`: `text-neutral-400 hover:text-white`} `}
                  onClick={()=>{
                    setLayout("list")
                  }}
                >
              ...
              <button className={`text-sm  text-neutral-500 hover:text-orange-500 flex justify-center items-center gap-1 transition-colors ${activeCategory !== "all" ||search !=="" ? "visible":"hidden"}`} onClick={() => {setActiveCategory("all"), setSearch("")} }>
   ...
   <div className="text-center py-20 bg-[#0a0a0a]">
    ...
    <div className="w-24 h-24 bg-[#161616] border border-[#262626] rounded-full flex items-center justify-center mx-auto mb-6">
      <i className="fa-regular fa-face-frown text-4xl  text-neutral-500"></i>
        ...
        <button className="px-8 py-4 rounded-4xl text-xl font-bold  bg-linear-to-r from-orange-500 to-orange-600 text-white inline-flex items-center gap-2 duration-300 transition-all cursor-pointer hover:-translate-y-1" onClick={() => {setActiveCategory("all"), setSearch("")} }>
   ...
   <div>
      ...
      <div className="bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12  ">
         ...
         {layout ==="list"?<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {currentItems.map((rep) => {
              return <Artical report={rep} />;
            })}
          </div>:<div className="flex flex-col gap-6">{currentItems.map((rep) => {
              return <List report={rep} />;
            })}</div>}

          

          {Math.ceil(filteredReports.length / itemsPerPage) > 1 && (<><div className="flex justify-center items-center gap-2 mt-12">
          <button
            disabled={currentPage === 1}
            onClick={() => setCurrentPage((prev) => Math.max(prev - 1, 1))}
         
            className={`p-3 rounded-xl border transition-all duration-300  border-[#262626] text-neutral-600  flex items-center justify-center w-[46px] h-[46px] ${currentPage === 1 ? `cursor-not-allowed bg-[#0a0a0a]` :"bg-[#161616] cursor-pointer"}` }
          >
            ...
            {Array.from(
              ...
              <button
                ...
                className={`px-3 py-1 rounded-md cursor-pointer ${
                  page === currentPage
                    ? "min-w-[44px] h-11 rounded-xl text-sm font-medium transition-all duration-300 bg-gradient-to-r from-orange-500 to-orange-600 text-white"
                    : "min-w-[44px] h-11 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/50 hover:text-white"
                }`}
              >
                {page}
              </button>
          ...
          <button
            ...
            className={`p-3 rounded-xl border transition-all duration-300   border-[#262626] text-neutral-600  flex items-center justify-center w-[46px] h-[46px] ${currentPage === Math.ceil(filteredReports.length / itemsPerPage) ? `cursor-not-allowed bg-[#000000]` :"bg-[#161616] cursor-pointer"}` }
          >
            <i className="fa-solid fa-angle-left"></i>
          
          </button>
        </div>
        <p className="text-center text-neutral-500 mt-4 text-sm">صفحة {currentPage} من { Math.ceil(filteredReports.length / itemsPerPage)}</p></>)}
