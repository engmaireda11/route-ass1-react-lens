...
export default function Main() {
  ...
  const [catgories, setCat] = useState([
  ...
  return (
    <>
      <div className="relative min-h-[90vh] flex items-center overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-yellow-500/5 rounded-full blur-3xl blob">
          {" "}
        </div>
...
bg-clip-text text-transparent"
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
              <Link
                className="  rounded-full font-bold bg-gradient-to-br from-orange-500 to-orange-600 px-8 py-4 text-lg text-white inline-flex items-center justify-center gap-2 group"
                to="/blog"
              >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              <div className="rounded-3xl bg-neutral-900/80 border border-neutral-800 p-6 p-4 hover:scale-105 transition-transform duration-300">
                <i className="fa-solid fa-newspaper text-2xl text-orange-500 mb-1" />
                <p
                  className="text-2xl md:text-3xl font-bold bg-gradient-to-br from-orange-500 to-yellow-400
bg-clip-text text-transparent"
                >
                  +50
                </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
            <div>
             ...
             rounded-full inline-flex items-center gap-2 mb-6"
              ...
              <p className="text-lg text-neutral-400 max-w-lg mt-[16px]">
            ...
            >
              عرض الكل
              <i className="fas fa-angle-left group-hover:-translate-x-1 transition-transform"></i>
            </Link>
          </div>
                  ...
                  <div className="p-8 md:p-10 flex flex-col justify-center bg-[#161616]">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          <img
                            alt={reports[1].author.name}
                            className="w-12 h-12 rounded-full object-cover ring-2 ring-[#262626] shadow-md"
                            src={reports[1].author.avatar}
                          />
                          <div className="absolute -bottom-1 -left-1 w-4 h-4 bg-orange-500 rounded-full border-2 border-[#161616]" />
                        </div>
                        <div>
                          <p className="text-sm font-semibold text-white">
                            {reports[1].author.name}
                          </p>
                          <p className="text-xs text-neutral-500">
                            {reports[1].date}
                          </p>
                  ...
                  <div className="p-8 md:p-10 flex flex-col justify-center bg-[#161616]">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          <img
                            alt={reports[2].author.name}
                            className="w-12 h-12 rounded-full object-cover ring-2 ring-[#262626] shadow-md"
                            src={reports[2].author.avatar}
                          />
                          <div className="absolute -bottom-1 -left-1 w-4 h-4 bg-orange-500 rounded-full border-2 border-[#161616]" />
                        </div>
                        <div>
                          <p className="text-sm font-semibold text-white">
                            {reports[2].author.name}
                          </p>
                          <p className="text-xs text-neutral-500">
                            {reports[2].date}
                          </p>
      ...
      <div className="py-24 bg-[#111111] relative border-y border-[#262626]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-400 mt-[16px] max-w-lg mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
            <div>
             ...
             rounded-full inline-flex items-center gap-2 mb-6"
              ...
              <p className="text-lg text-neutral-400 mt-[16px] max-w-lg">
            ...
            >
              عرض جميع المقالات
              <i className="fas fa-arrow-left-long  group-hover:-translate-x-1 transition-transform"></i>
            </Link>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <article className="group card overflow-hidden bg-[#161616] rounded-3xl">
              <Link className="block" to={`/blog/${reports[3].slug}`}>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-[#262626]">
                    <div className="flex items-center gap-3">
                      <img
                        alt={reports[3].author.name}
                        className="w-9 h-9 rounded-full object-cover ring-2 ring-[#262626]"
                        src={reports[3].author.avatar}
                      />
                      <div>
                        <p className="text-sm font-medium text-white">
                          {reports[3].author.name}
                        </p>
                        <p className="text-xs text-neutral-500">
                          {" "}
                          {reports[3].author.role}
                        </p>
                      </div>
                    </div>
            ...
            <article className="group card overflow-hidden bg-[#161616] rounded-3xl">
              <Link className="block" to={`/blog/${reports[4].slug}`}>
                <div className="relative h-52 overflow-hidden">
                  <img
                    alt={reports[4].title}
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 ease-out"
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-[#262626]">
                    <div className="flex items-center gap-3">
                      <img
                        alt={reports[4].author.name}
                        className="w-9 h-9 rounded-full object-cover ring-2 ring-[#262626]"
                        src={reports[4].author.avatar}
                      />
                      <div>
                        <p className="text-sm font-medium text-white">
                          {reports[4].author.name}
                        </p>
                        <p className="text-xs text-neutral-500">
                          {" "}
                          {reports[4].author.role}
                        </p>
                      </div>
                    </div>
                    <div className="w-8 h-8 rounded-full bg-orange-500/10 flex items-center justify-center group-hover:bg-orange-500 transition-colors duration-300 border border-orange-500/20 group-hover:border-transparent">
            ...
            <article className="group card overflow-hidden bg-[#161616] rounded-3xl">
              <Link className="block" to={`/blog/${reports[5].slug}`}>
                <div className="relative h-52 overflow-hidden">
                  <img
                    alt={reports[5].title}
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 ease-out"
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-[#262626]">
                    <div className="flex items-center gap-3">
                      <img
                        alt={reports[5].author.name}
                        className="w-9 h-9 rounded-full object-cover ring-2 ring-[#262626]"
                        src={reports[5].author.avatar}
                      />
                      <div>
                        <p className="text-sm font-medium text-white">
                          {reports[5].author.name}
                        </p>
                        <p className="text-xs text-neutral-500">
                          {" "}
                          {reports[5].author.role}
                        </p>
                      </div>
                    </div>
                    <div className="w-8 h-8 rounded-full bg-orange-500/10 flex items-center justify-center group-hover:bg-orange-500 transition-colors duration-300 border border-orange-500/20 group-hover:border-transparent">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#161616] rounded-3xl border border-[#262626] p-8 md:p-12 lg:p-16 text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              اشترك في <span className="bg-gradient-to-br from-orange-500 to-yellow-400
bg-clip-text text-transparent">نشرتنا الإخبارية</span>
            </h2>
