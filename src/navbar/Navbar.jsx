        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <NavLink className="flex items-center gap-3 group" to="/">
              <div className="relative w-12 h-12 rounded-xl group-hover:scale-105 transition-all duration-300">
                <img
                  alt="Photography"
     ...
     isActive
       ...
       : "text-neutral-400 hover:text-white"
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <NavLink
                className="px-8 py-4 rounded-4xl text-sm font-medium  bg-linear-to-r from-orange-500 to-orange-600 text-white"
                to="/blog"
